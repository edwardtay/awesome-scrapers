...
|------|-------|----------|-------------|
| [Firecrawl](https://github.com/firecrawl/firecrawl) | 175k | TypeScript | Websites → LLM-ready markdown or structured data via API. |
| [browser-use](https://github.com/browser-use/browser-use) | 112k | Python | AI agents that control a browser to complete tasks autonomously. |
| [Crawl4AI](https://github.com/unclecode/crawl4ai) | 81k | Python | LLM-friendly web crawler with structured extraction. |
...
| Tool | Stars | Language | Description |
|------|-------|----------|-------------|
| [Scrapling](https://github.com/D4Vinci/Scrapling) | 77k | Python | Adaptive scraping with built-in anti-detection and auto-matching. |
...
| [Playwright](https://github.com/microsoft/playwright) | 95k | Multi | Cross-browser automation (Chromium, Firefox, WebKit) by Microsoft. |
...
| [got-scraping](https://github.com/apify/got-scraping) | 769 | Node.js | HTTP client with header/TLS mimicry by Apify. |
...
| Tool | Stars | Description |
|------|-------|-------------|
| [yt-dlp](https://github.com/yt-dlp/yt-dlp) | 188k | YouTube and 1000+ sites (fork of youtube-dl). |
